 ...
 */
package nl.tricode.magnolia.events.form;
...
public class UniqueNameSaveFormAction extends SaveFormAction {
    ...
    protected void setNodeName(Node node, JcrNodeAdapter item) throws RepositoryException {
        try {
			if (item.isNew() || EventsWorkspaceUtil.hasNameChanged(node, getDefinition().getPropertyName())) {
			    final String newNodeName = EventsWorkspaceUtil.generateUniqueNodeName(node, getDefinition().getPropertyName());
